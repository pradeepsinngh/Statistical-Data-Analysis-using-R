...
# Problem 2:
* Create a factor variable called SBP.H that records whether or not the subjects have high systolic blood pressure. Here subjects with SBP ≥ 140 are considered to have high SBP. The levels of the variable SBP.H should be “High SBP” and “Normal SBP”. Create side-by-side histograms of DBP by SBP.H.
* Create side-by-side boxplots of DBP by SBP.H.
